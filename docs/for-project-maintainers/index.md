...
This is **Mode A** in [Code of Conduct §4.3.1](https://github.com/agentic-commons-foundation/.github/blob/main/CODE_OF_CONDUCT.md#431-two-operational-modes). It is the default. It does not require you to do anything.
...
[`guides` Q&A Discussions](https://github.com/agentic-commons-foundation/guides/discussions/categories/q-a), or `hello@agentic-commons.org` for direct conversation.
